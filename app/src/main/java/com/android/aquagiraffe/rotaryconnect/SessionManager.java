...
public class SessionManager
{
     ...
     * */
    public void createLoginSession(String name, String email, String mobile, String rid, String strDOb){
        ...
        editor.putString(KEY_DOB,strDOb);
    ...
    public HashMap<String, String> getUserDetails(){
        ...
        user.put(KEY_RID, pref.getString(KEY_RID, null));
