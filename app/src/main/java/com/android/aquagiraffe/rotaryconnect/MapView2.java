...
public class MapView2 extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MapView2.this, FindUsActivity.class);
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                googleMap.addMarker(new MarkerOptions()
                        ...
                        .title("Conference Hall,Smt.Savitridevi Thirani Vidyamandir Vartak Nagar Pokharan Road 1, Thane West")
    ...
    private void getAddress2() {
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                googleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(19.211825, 72.96057480000002), 10));
