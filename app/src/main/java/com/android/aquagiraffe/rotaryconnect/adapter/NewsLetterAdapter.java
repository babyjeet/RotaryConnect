...
{
    NewsletterActivity newsletterActivity = new NewsletterActivity();
    Context c;
    ArrayList<PdfModel> spacecrafts;
    ArrayList <String> filePaths;

    ImageView imageView, img_cross, img_pdf_upload;
    TextView textView;

    public NewsLetterAdapter(Context c, ArrayList<PdfModel> spacecrafts, ArrayList <String> filePaths)
    {
        this.c = c;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            convertView = LayoutInflater.from(c).inflate(R.layout.pdfmodel, parent,false);
        }

        textView = convertView.findViewById(R.id.nameTxt);

        imageView = convertView.findViewById(R.id.spacecraftImg);
        textView.setText(pdfModel.getName());
        textView.setTypeface(Typeface.createFromAsset(c.getAssets(),"RobotoBold.ttf"));
        img_cross = convertView.findViewById(R.id.img_cross);
